...
//CSS for Elements Text Box
    ...
    private WebElementFacade doubleClickElement;
    ...
    public void verifyTextBoxPageMsg(String message) {
        shouldContainText(message);
    }

    public void verifyUserInformation(String userInformation) {
        shouldContainText(userInformation);
    }
